...
module Ggen
  ...
  class Options
    @defaults = {
      ...
      :game_id              => nil,
      :reference_root       => Pathname.new('/mnt/Development'),
      :template_root             => Pathname.new(File.dirname(File.realdirpath(__FILE__))) + 'template',
      :reference_game  => nil,
      :output_game     => nil,
      :template_game   => nil,
      ...
      :base_symbols         => nil,
      :bonus_symbols        => nil,
      :output_root               => Pathname.new('./Development'),
